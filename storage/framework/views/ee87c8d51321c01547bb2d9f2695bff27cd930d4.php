...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['order-list', 'order manage'])): ?>
<li>
...
<li>
  ...
  <div class="collapse" id="siebar-product">
    <ul class="nav-second-level">
      <li><a href="<?php echo e(route('products.index')); ?>"><i data-feather="file-plus"></i> Product Manage</a></li>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['setting-list', 'social-list', 'contact-list', 'email-setting-list', 'fraud-setting-list', 'api-manage', 'pixel-manage', 'seo-manage', 'sitemap-manage'])): ?>
<li>
  <a href="#sidebar-system-settings" data-bs-toggle="collapse">
    <i data-feather="settings"></i>
    <span> System Settings </span>
    <span class="menu-arrow"></span>
  </a>
  <div class="collapse" id="sidebar-system-settings">
    <ul class="nav-second-level">
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['setting-list', 'social-list', 'contact-list'])): ?>
        <li><a href="<?php echo e(route('settings.index')); ?>"><i data-feather="monitor"></i> General Setting</a></li>
        <li><a href="<?php echo e(route('socialmedias.index')); ?>"><i data-feather="share-2"></i> Social Media</a></li>
        <li><a href="<?php echo e(route('contact.index')); ?>"><i data-feather="phone"></i> Contact</a></li>
        <li><a href="<?php echo e(route('pages.index')); ?>"><i data-feather="file-text"></i> Create Page</a></li>
        <li><a href="<?php echo e(route('shippingcharges.index')); ?>"><i data-feather="truck"></i> Shipping Charge</a></li>
      <?php endif; ?>

      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('email-setting-list')): ?>
        <li><a href="<?php echo e(route('email_setting')); ?>"><i data-feather="mail"></i> Email Settings</a></li>
      <?php endif; ?>

      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fraud-setting-list')): ?>
        <li><a href="<?php echo e(route('admin.fraud.index')); ?>"><i data-feather="shield"></i> Fraud API</a></li>
      <?php endif; ?>

      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['api-manage'])): ?>
        <li><a href="<?php echo e(route('paymentgeteway.manage')); ?>"><i data-feather="credit-card"></i> Payment Gateway</a></li>
        <li><a href="<?php echo e(route('smsgeteway.manage')); ?>"><i data-feather="message-square"></i> SMS Gateway</a></li>
        <li><a href="<?php echo e(route('courierapi.manage')); ?>"><i data-feather="package"></i> Courier API</a></li>
      <?php endif; ?>

      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['pixel-manage'])): ?>
        <li><a href="<?php echo e(route('tagmanagers.index')); ?>"><i data-feather="tag"></i> Tag Manager</a></li>
        <li><a href="<?php echo e(route('pixels.index')); ?>"><i data-feather="crosshair"></i> Pixel Manage</a></li>
      <?php endif; ?>

      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('seo-manage')): ?>
        <li><a href="<?php echo e(route('admin.seo_settings.index')); ?>"><i data-feather="globe"></i> SEO Settings</a></li>
      <?php endif; ?>

      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sitemap-manage')): ?>
        <li><a href="<?php echo e(route('admin.sitemap.index')); ?>"><i data-feather="map"></i> Sitemap Settings</a></li>
      <?php endif; ?>
    </ul>
  </div>
</li>
...
<li>
  ...
  <div class="collapse" id="siebar-banner">
    <ul class="nav-second-level">
      <li><a href="<?php echo e(route('banner_category.index')); ?>"><i data-feather="file-plus"></i> Banner Category</a></li>
      <li><a href="<?php echo e(route('banners.index')); ?>"><i data-feather="file-plus"></i> Banner & Ads</a></li>
    </ul>
  </div>
</li>
<?php endif; ?>
...
<?php /**PATH D:\ecom2\resources\views/backEnd/layouts/master.blade.php ENDPATH**/ ?>