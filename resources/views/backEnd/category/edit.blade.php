                ...
                <form action="{{route('categories.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <!-- col-end -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control @error('icon') is-invalid @enderror" name="icon" value="{{ $edit_data->icon }}"  id="icon" >
                            <img src="{{asset($edit_data->icon)}}" alt="" class="edit-icon">
                            @error('icon')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
