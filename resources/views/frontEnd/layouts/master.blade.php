...
<div class="menu-bag">
    @if(Auth::guard('customer')->user())
        <a href="{{ route('customer.account') }}" class="margin-shopping">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 mb-3 mb-sm-0">
                            <div class="footer-menu">
                                ...
                                @if($generalsetting->app_download_image || $generalsetting->app_download_link)
                                <div class="d_app mt-3">
                                    <h2 style="color: #fff; font-size: 16px; margin-bottom: 10px;"></h2>
                                    <a href="{{ $generalsetting->app_download_link ?? '#' }}" target="_blank">
                                        <img src="{{ asset($generalsetting->app_download_image ?? 'frontEnd/images/app-download.png') }}" alt="Download App" style="max-width: 140px; border-radius: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'"/>
                                    </a>
                                </div>
                                @else
                                <div class="d_app mt-3">
                                    <h2 style="color: #fff; font-size: 16px; margin-bottom: 10px;"></h2>
                                    <a href="#">
                                        <img src="{{asset('frontEnd/images/app-download.png')}}" alt="Download App" style="max-width: 140px; border-radius: 5px;" />
                                    </a>
                                </div>
                                @endif
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
                                ...
                                <p><span style="color: white;">Copyright © {{ date('Y') }} {!! $generalsetting->copyright ?? $generalsetting->name !!}. All rights reserved</span> | <span style="color: white;">Website Designed by: {!! $generalsetting->designed_by ?? '<a href="https://www.creativedesign.com.bd"><span style="color: white;">Creative Design</span></a>' !!}</span></p>
                            </div>
                        </div>
                    </div>
                </div>
